...
import com.ict.khj.sns.kakao.KakaoVO;
import com.ict.khj.sns.naver.NaverVO;
...
public class SnsController {
	...
	public ModelAndView getSpringSnsGo() {
		return new ModelAndView("sns/login_join");
	}
	...
	public ModelAndView KakaoLogIn(HttpServletRequest request) {
		...
		try {
			...
			sb.append("&client_id=fd60b99038af5660740fc392bf2773d1");
	...
	public ModelAndView naverlogin(HttpServletRequest request) {
		...
		try {
			...
			StringBuffer sb = new StringBuffer();
			sb.append("grant_type=authorization_code");
			sb.append("&client_id=atErapZRsfL7ObQl3Er1");
			sb.append("&client_secret=YnYh5t0bzD");
			sb.append("&code=" + code);
	...
	public ModelAndView getSnsLogout(HttpSession session) {
		...
		String apiURL = "https://nid.naver.com/oauth2.0/token" + "?grant_type=delete"
				+ "&client_id=atErapZRsfL7ObQl3Er1" + "&client_secret=YnYh5t0bzD" + "&access_token="
